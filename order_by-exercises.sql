...
select * from employees where first_name = "Irena" or first_name = "Vidya" or first_name = "Maya" order by first_name; #709 records returned
 /*709 record returned, the first person of the result is Irena Reutenauer | Last person of the result is Vidya Simmen*/
